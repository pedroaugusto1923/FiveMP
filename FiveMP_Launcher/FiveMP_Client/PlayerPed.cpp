...
/*CPlayerPed::CPlayerPed()
{
	if (PLAYER::GET_PLAYER_PED(0))
		curPedPtr = (Ped*)PLAYER::PLAYER_PED_ID();
	c_playerid = 0;
}

CPlayerPed::CPlayerPed(int iPlayerNumber, int iModel, float fX, float fY, float fZ, float fRotation)
{
	c_playerid = (BYTE)iPlayerNumber;
